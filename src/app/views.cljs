...
(defn app []
  [:main
   [:container
    ...
    [:div.col
      [:p "A novel species-specific machine vision technique to detect soil microarthropods. A novel species-specific machine vision technique to detect soil microarthropods."]
    ...
    [:div.content
     ...
     [:div.device
        [:div.headline
          [:h2 "The Device"]]
        [:p "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ipsum tortor sed pharetra, diam. Sapien, feugiat eu pellentesque purus nunc maecenas adipiscing sed non. Velit, vulputate natoque quam amet vitae."]
        [:div.imgrow-cad
